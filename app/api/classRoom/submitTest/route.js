...
I am providing the student's question paper and their answers in JSON format below. give the response in html format with proper styling with tailwindcss so that i can directly apply show it on the frontend. Don't give it in <html> instead directly give it in a div no header or extra things are required follow the same ui for every response.Also it should be responsive.
