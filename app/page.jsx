    ...
    <div className="w-full h-auto overflow-hidden">
      ...
      >
        ...
        <div className="w-full h-auto px-5 py-10 bg-slate-50 flex flex-col gap-5 md:flex-row md:items-center md:justify-center md:p-15 dark:text-white dark:bg-gray-800">
          <div className="bg-white p-5 pl-7 shadow-md rounded-lg md:p-10 dark:text-white dark:bg-gray-800  dark:border-white ">
            <Wand2 size={20} />
          ...
          <div className="bg-white p-5 pl-7 shadow-md rounded-lg md:p-10 dark:bg-gray-800  dark:border-white">
            <TrendingUp size={20} />
        ...
        <div className="p-5 w-full h-auto md:p-15 dark:bg-gray-800 ">
          <div className="bg-black text-white px-5 py-10 rounded-2xl flex flex-col gap-2 md:p-15 text-center md:items-center md:gap-5  dark:border-white dark:bg-gray-800">
            <p className="font-extrabold text-2xl md:text-5xl md:leading-16 ">
